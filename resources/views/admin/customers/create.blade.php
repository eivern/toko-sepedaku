...
<div
    ...
    <form class="space-y-6" action="{{ route('admin.customers.store') }}" method="POST">
        @csrf
        <h5 class="text-xl font-medium text-gray-900 dark:text-white">Tambah Customer Baru</h5>
        <div>
        ...
        <div>
            ...
            <input type="tel" name="phone" id="phone"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                placeholder="08xxxxxxxx" required value="{{ old('phone') }}">
        </div>
        <div>
            ...
            <textarea id="address" name="address" rows="4"
                ...
                placeholder="Tulis alamat lengkap customer...">{{ old('address') }}</textarea>
        </div>
        <button type="submit"
