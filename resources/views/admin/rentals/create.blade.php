    ...
    <form class="space-y-6" action="{{ route('admin.rentals.store') }}" method="POST" id="rental-form">
        ...
        <div>
            ...
            <select id="customer_id" name="customer_id"
                ...
                required>
                <option selected disabled value="">-- Pilih atau Cari Customer --</option>
        ...
        <div>
            ...
            <select id="bicycle_id" name="bicycle_id"
                ...
                <option value="{{ $bicycle->id }}" data-price="{{ $bicycle->price_per_hour }}" {{
                    old('bicycle_id')==$bicycle->id ? 'selected' : '' }}>
        ...
        <div>
            ...
            <input type="number" name="duration_hours" id="duration_hours"
                ...
                placeholder="Contoh: 2" min="1" required value="{{ old('duration_hours') }}">
        </div>

        <div class="p-4 bg-blue-50 border border-blue-200 rounded-lg dark:bg-gray-700 dark:border-blue-500">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Initial calculation on page load if values are pre-filled from old input
        calculateTotal();
    });
</script>
@endsection